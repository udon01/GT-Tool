    ...
    public partial class Form1 : Form
    {
        ...
        private async void Start_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                racefinishover = 0;
                if (Alwaysstickcheck.Checked == false || ComboBoxhandle.Text == "方向キー")
                {
                    while (true)
                    {
                        if (ComboBoxhandle.Text == "方向キー")
        ...
        private void Modosu_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK)
            {
                ...
                Waitentry2.Value = Convert.ToDecimal(13.5);
                Waitbacktomenu.Value = Convert.ToDecimal(6.5);
                Racefinishmin.Value = 4;
                Racefinishsec.Value = 4;
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                if (stream != null)
                {
                    ...
                    while (line != null)
                    {
                        ...
                        else if (0 <= line.IndexOf("レース終了まで："))
                        {
                            line = line.Remove(0, line.IndexOf("：") + 1);
                            line = line.Replace("秒", "");
                            string line2 = line;
